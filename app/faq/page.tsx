...
export const metadata = {
  title: "FAQ - LoveYuu",
  description: "Perguntas frequentes sobre o LoveYuu. Tire suas duvidas sobre como criar sua pagina personalizada.",
}

const faqs = [
  {
    question: "Como funciona o LoveYuu?",
    answer: "O LoveYuu permite que voce crie uma pagina personalizada para celebrar seu relacionamento. Voce preenche os dados do casal, faz upload de fotos, escreve uma mensagem especial e recebe um QR Code unico que pode ser compartilhado com seu parceiro(a).",
  },
  {
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Encontre respostas para as duvidas mais comuns sobre o LoveYuu.
              </p>
            </div>
            ...
            <Card className="mt-16">
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  <a
                    href="mailto:contato@loveyuu.com"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">contato@loveyuu.com</p>
                    </div>
                  </a>
                  <a
