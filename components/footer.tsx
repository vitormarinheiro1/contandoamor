    ...
    <footer className="border-t border-border/40 bg-muted/30">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-serif text-xl font-semibold text-foreground">LoveYuu</span>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a href="mailto:contato@loveyuu.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                contato@loveyuu.com
              </a>
            </nav>
          </div>
        ...
        <div className="mt-12 border-t border-border/40 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} LoveYuu. Todos os direitos reservados. Feito com{" "}
